...
describe('demo/list_table.md', function()
    ...
    local function shared()
        ...
        util.add_bullet(marks, row:get(1, 0), { 2, 6 }, 2, 2)
        util.add_bullet(marks, row:get(1, 0), { 4, 6 }, 2)
        util.add_bullet(marks, row:get(1, 0), { 6, 8 }, 3)
        util.add_bullet(marks, row:get(1, 0), { 8, 10 }, 4)
        util.add_bullet(marks, row:get(1, 0), { 10, 12 }, 1)
        util.add_bullet(marks, row:get(1, 0), { 0, 2 }, 1)
